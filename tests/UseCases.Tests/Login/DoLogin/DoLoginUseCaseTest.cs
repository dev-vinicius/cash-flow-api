...
public class DoLoginUseCaseTest
{
    ...
    private DoLoginUseCase CreateUseCase(CashFlow.Domain.Entities.User user, string? password = null)
    {
        ...
        var userRepository = new UserReadOnlyRepositoryBuilder().GetUserByEmailAsync(user).Build();

        return new DoLoginUseCase(userRepository, passwordEncripter, tokenGenerator);
    }
}
